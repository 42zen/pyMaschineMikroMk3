...
class MyMaschinePrinterExample(MaschineMikroMk3):
    ...
    def pad_released(self, pad_id):
        print(f"The pad {pad_id} was released.")

    # a pad velocity changed
    def pad_velocity_changed(self, pad_id, velocity):
        #print(f"The pad {pad_id} velocity changed to {velocity}.")
        pass

    # a button was pushed
    def button_pushed(self, button):
        print(f"The button {button} was pushed.")

    # a button was released
    def button_released(self, button):
        print(f"The button {button} was released.")

    # the knob was touched
    def knob_touched(self):
        print(f"The knob was touched.")

    # the knob was released
    def knob_released(self):
        print(f"The knob was released.")

    # the knob was moved right
    def knob_moved_right(self):
        print(f"The knob moved to the right.")

    # the knob was moved left
    def knob_moved_left(self):
        print(f"The knob moved to the left.")

    # the strip was pushed
    def strip_pushed(self, finger_count=1):
        print(f"{'Two fingers were' if finger_count == 2 else 'A finger was'} added to the strip.")

    # the strip was released
    def strip_released(self, finger_count=1):
        print(f"{'Two fingers were' if finger_count == 2 else 'A finger was'} removed from the strip.")

    # the strip positions changed
